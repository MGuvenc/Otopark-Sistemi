	...
	if(!empty($_POST["kAdi"]) and !empty($_POST["mail"]) and !empty($_POST["sifre"])){
		...
		if(mysqli_num_rows($rUser)>0){
			...
			if ($conn->query($insertUser) === TRUE) {
				$mesaj = '<div class="alert alert-success">Patron Ekleme Başarılı!</div>';
			} else {
				...
				<div id="page" class="dashboard">
					<div class="widget box light-grey">
						<div class="widget-title">
							<h4><i class="icon-user"></i> Yönetici Ekle</h4>
						</div>
						<div class="widget-body form">
							...
							<form action="" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
								<div class="control-group">
									...
									<div class="controls">
										<input name="kAdi" type="text" class="span5" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Mail</label>
									<div class="controls">
										<input name="mail" type="email" class="span5" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Şifre</label>
									<div class="controls">
										<input name="sifre" type="password" class="span5" />
									</div>
								</div>
								<div class="form-actions">
									<button type="submit" onclick="submit();" class="btn btn-primary"><i class="icon-ok"></i> Ekle</button>
								</div>
							</form>
						</div>
					</div>
